...
class DoctorDetais extends StatefulWidget {
  const DoctorDetais({super.key});

  @override
  State<DoctorDetais> createState() => _DoctorDetaisState();
}

class _DoctorDetaisState extends State<DoctorDetais> {
